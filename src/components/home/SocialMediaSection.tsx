        ...
        <div className="flex justify-center gap-4">
          {activeSocials.map(([key, { icon, label, color }]) => (
            <motion.a
              ...
              className={`w-12 h-12 rounded-2xl bg-secondary/50 border border-border/50 flex items-center justify-center text-muted-foreground ${color} hover:border-primary/40 transition-colors`}
            >
              {icon}
            </motion.a>
          ))}
