...
import {
  ...
  ChevronRight, Menu, X, Shield, MessageCircle, CreditCard, Activity, Star, Gift, Settings, AlertTriangle, Clock, Bot, Database, Send, Megaphone, Package, CalendarDays, Link2, Radar, Network
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { path: "/dashboard/notifications", label: "الإشعارات", icon: Bell, adminOnly: true },
  ...
  { path: "/dashboard/verification-gateway", label: "Verification Gateway", icon: Shield, adminOnly: true },
