      ...
      <div className="container py-10 max-w-2xl">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-6">
            ...
            {/* Submit */}
            {!isAlreadySubscribed && (() => {
              const blockReason = !selectedPackageId
                ? "اختر باقة الاشتراك أولاً"
                : showPaymentSkeleton
                  ? "جاري تحميل معلومات الدفع... يرجى الانتظار"
                  : paymentInfoMissing
                    ? "تعذّر تحميل معلومات الدفع (CCP/BaridiMob). أعد المحاولة قبل الإرسال"
                    : !hasPaymentInfo
                      ? "معلومات الدفع غير متوفرة حالياً"
                      : null;
              ...
              return (
                <div className="space-y-2">
                  <button
                    ...
                    aria-disabled={submitting || isBlocked}
                    title={blockReason ?? undefined}
                    className="w-full py-4 rounded-xl font-bold gradient-primary text-primary-foreground hover:opacity-90 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {submitting ? (
